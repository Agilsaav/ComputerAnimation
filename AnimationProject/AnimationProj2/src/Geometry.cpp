...
// Rectangle
//****************************************************
GRectangle::GRectangle(const glm::vec2& point, const float& h, const float& w)
{
	pos = point;
	width = w;
	height = h;
...
void GRectangle::setPosition(const glm::vec3& newPos)
{
	pos = glm::vec2 (newPos.x, newPos.z);
}

bool GRectangle::isInside(const glm::vec3& point)
{
	return false;
}
